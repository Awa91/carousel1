...
export default function ResponsiveCarousel(){
    return(<>
    <body className="bg-gray-200 leanding-normal tracking-wide">

<h1 className="mx-12 my-10 text-gray-700 text-5xl lg:text-6xl text-center font-poppins"     style={{background: 'font-family:  cursive, sans-serif;'}}>
    Carousel with Tailwind
</h1>

<div className="container mx-auto w-full overflow-hidden relative">
    <div className="w-full h-full absolute">
        <div className="w-1/4 h-full absolute z-50 left-0" style={{background: 'linear-gradient(to left, #edf2f7 0%, rgba(255, 255, 255, 0) 100%);'}}></div>
