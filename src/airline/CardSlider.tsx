            ...
            <section className="px-12">
                <div className="max-w-lg mx-auto relative  ">
                    ...
                    ">
                        ...
                        <article className="bg-white p-6 rounded-lg shadow-2xl">
                            <header className="mb-2">
                                <img className="inline-flex rounded-full shadow mb-3" src="./1.jpg" width="44" height="44" alt="Icon" />
                                <h1 className="text-xl font-bold text-slate-900">Focus #1 on the big picture</h1>
                            </header>
                    ...
                    ">
                        ...
                        <article className="bg-white p-6 rounded-lg shadow-2xl">
                            <header className="mb-2">
                                <img className="inline-flex rounded-full shadow mb-3" src="./icon.svg" width="44" height="44" alt="Icon" />
